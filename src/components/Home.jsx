...
import realProfile from "../assets/img/1.webp";
import hoverProfile from "../assets/img/1.webp";
    ...
    <>
      ...
      <Container fluid className="home-wrapper">
        <div className="home-left animate__animated animate__fadeInLeft">
          ...
          <h2>
            <span className="name-hover">Faisal</span>
            <br />
            <span className="name-hover">Amri</span>
          </h2>
